...
public class GolfTournamentController {
    ...
    public GolfTournamentInfo addGolfer(@PathVariable Long tournamentId, @RequestBody GolferRequest request) {
        return service.addGolferToTournament(tournamentId, request);
    }
